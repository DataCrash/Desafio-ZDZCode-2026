...
1. `138eee8` - feat(frontend): refinamento visual e acessibilidade do tema Neo Clean
...
1. `820dbef` - chore(frontend): padroniza microcopy de erros no CRUD

- Mensagens de erro harmonizadas para consistencia de linguagem na UI.

1. `939a661` - chore(frontend): incorpora ajuste pendente em produtos
